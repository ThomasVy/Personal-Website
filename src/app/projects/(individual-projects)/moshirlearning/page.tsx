  ...
  return (
    ...
    >
      <p>
        ...
        they're enrolled in and that are active, view and download assignments,
        view grades, upload assignment submissions, view other students enrolled
        in the class, and send an email to the professor. In the video, the
        program on the left is the professor and the program on the right is the
        student. This project was completed for ENSF 409 in 2017 and won
