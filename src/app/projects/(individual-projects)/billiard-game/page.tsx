  ...
  return (
    ...
    >
      <p>
        ...
        &apos;1&apos; to bring you back to the menu, press and hold spacebar to
        charge your shots. Press &apos;b&apos; to reset your shot power. After
        winning or losing, press any key to reset the game. <br />
